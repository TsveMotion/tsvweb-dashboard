...
export default function CRMOverview({ darkMode }: { darkMode: boolean }) {
  return (
    <div
              ...
              <div key={item.label} className="space-y-1">
                ...
                <div className="h-2 w-full rounded-full bg-gray-200 dark:bg-gray-800">
                  <div
                    ...
                    style={{ width: `${(item.value / 128) * 100}%`, background: item.color }}
                  />
                </div>
              </div>
            ))}
